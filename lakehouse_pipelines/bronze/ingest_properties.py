"""
Bronze Layer: Ingest raw property data into Delta Lake.

Legacy equivalent: COPY raw.properties FROM 's3://...' CSV
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName("bronze_ingest_properties").getOrCreate()
    rows = ingest_batch(spark, args.source, args.target)
    print(f"Ingested {rows:,} properties to Bronze")
    spark.stop()
