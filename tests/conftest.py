...
def sample_policies(spark):
    ...
    data = [
        ("POL-001", " John ", " Smith ", " john@test.com ", "PROP-001", "HO3",
         "2024-01-01", "2025-01-01", " active ", 1200.50, 1000.0, 300000.0,
         "AGT-001", "ONLINE", "2023-12-15T00:00:00", "2024-01-01T00:00:00"),
        ("POL-002", "Jane", "Doe", "jane@test.com", "PROP-002", "ho5",
         "2024-03-15", "2025-03-15", "CANCELLED", 2500.00, 2000.0, 500000.0,
         "AGT-002", "AGENT", "2024-03-01T00:00:00", "2024-06-01T00:00:00"),
        (None, "Bad", "Record", "bad@test.com", "PROP-003", "DP1",
         "2024-05-01", "2025-05-01", "ACTIVE", 800.0, 500.0, 100000.0,
         "AGT-003", "ONLINE", "2024-04-20T00:00:00", "2024-05-01T00:00:00"),
    ]
    schema = StructType([
...
def sample_claims(spark):
    ...
    data = [
        ("CLM-001", "POL-001", "2024-06-15", "2024-06-16", "2024-08-01",
         "WIND_DAMAGE", "CLOSED", 15000.0, 12000.0, 1000.0,
         "ADJ-001", "HURRICANE", "Wind damage claim",
         "2024-06-16T00:00:00", "2024-08-01T00:00:00"),
        ("CLM-002", "POL-001", "2024-09-01", "2024-09-03", "",
         "water_damage", "OPEN", 5000.0, 0.0, 0.0,
         "ADJ-002", "BURST_PIPE", "Pipe burst",
         "2024-09-03T00:00:00", "2024-09-10T00:00:00"),
    ]
    schema = StructType([
